...
<html lang="en">
    ...
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="assets/images/rots.ico">
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            <div class="card-header text-center p-4 bg-primary">
                                <h4 class="text-white mb-0 mt-0"><img style="width:250px" src="<?= base_url(); ?>assets/images/layouts/logo.gif" alt=""></h4>
                            </div>
                            <div class="card-body">
                            <?php 
