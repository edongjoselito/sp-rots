                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <?= form_open_multipart('res_add'); ?>


                                        <div class="form-row">
                                                <div class="form-group col-md-8">
                                                    <label for="inputResolutionNo" class="col-form-label">Resolution No.</label>
                                                    <input type="text" value="<?= set_value('ResolutionNo'); ?>" name="ResolutionNo" class="form-control">
                                                </div>  
                                        ...
                                        <div class="form-row">
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input type="date" value="<?= set_value('Effectivity'); ?>" name="Effectivity" class="form-control">
                                                </div> 
                                                <div class="form-group col-md-4">
                                            ...
                                            <button type="submit" value="submit" class="btn btn-primary">Create New Resolution</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
