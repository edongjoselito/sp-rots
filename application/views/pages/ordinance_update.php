                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <?= form_open('ordinance_edit/'.$id); ?>

                                        <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="inputOrdinanceNo" class="col-form-label">Ordinance No.</label>
                                                    <input type="text" value="<?= $OrdinanceNo; ?>" name="OrdinanceNo" class="form-control">
                                                </div> 
                                        ...
                                        <input type="hidden" name="id" value="<?= $id; ?>">
                                            ...
                                            <button type="submit" value="submit" class="btn btn-primary">Update Ordinance</button>
                                        </form>
