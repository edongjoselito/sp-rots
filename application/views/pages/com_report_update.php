                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <?= form_open('Pages/committee_report_edit/'.$page->id); ?>
                                            <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="date" value="<?= $page->fr; ?>" name="fr" class="form-control">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="inputname" class="col-form-label">Second Reading</label>
                                                    <input type="date" value="<?= $page->sr; ?>" name="sr" class="form-control">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="inputname" class="col-form-label">Third & Final Reading</label>
                                                    <input type="date" value="<?= $page->tr; ?>" name="tr" class="form-control">
                                                </div>
                                            </div>
