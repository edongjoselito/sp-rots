            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li><a href="<?= base_url(); ?>Pages/cat_com">Communication Category</a></li>
                                    ...
                                    <li>
                                        <a href="javascript: void(0);">
                                            ...
                                            <ul class="nav-fourth-level nav" aria-expanded="false">
                                                <?php 
                                                    $cat = $this->Page_model->get_where_posts('category');
                                                    foreach($cat as $row){ ?>
                                                    <li>
                                                        <a href="<?= base_url().'res_reports/'.$row['name']; ?>"><?= $row['name']; ?></a>
                                                    </li>
                                        ...
                                        <a href="javascript: void(0);">
                                            ...
                                            <ul class="nav-fourth-level nav" aria-expanded="false">
                                                ...
                                                <?php 
                                                        ...
                                                        foreach($cat as $row){ ?>
                                                        <li>
                                                            <a href="<?= base_url().'or_reports/'.$row['name']; ?>"><?= $row['name']; ?></a>
                                                        </li>
